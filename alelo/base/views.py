...
def janeiro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/janeiro.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_janeiro_dct = Janeiro.objects.aggregate(Sum('valor'))
    total_mes_janeiro = total_mes_janeiro_dct['valor__sum']
    valores_mes = Janeiro.objects.all()
    return render(request, 'base/janeiro.html', {'valores_mes': valores_mes, 'total_mes_janeiro': total_mes_janeiro})
...
def apagar_valor_janeiro(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:janeiro'))
    return render(request, 'base/janeiro.html', {'valor': valor})
...
def fevereiro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/fevereiro.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_fevereiro_dct = Fevereiro.objects.aggregate(Sum('valor'))
    total_mes_fevereiro = total_mes_fevereiro_dct['valor__sum']
    valores_mes = Fevereiro.objects.all()
    return render(request, 'base/fevereiro.html',
...
def apagar_valor_fevereiro(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:fevereiro'))
    return render(request, 'base/fevereiro.html', {'valor': valor})
...
def marco(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/marco.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_marco_dct = Marco.objects.aggregate(Sum('valor'))
    total_mes_marco = total_mes_marco_dct['valor__sum']
    valores_mes = Marco.objects.all()
    return render(request, 'base/marco.html', {'valores_mes': valores_mes, 'total_mes_marco': total_mes_marco})
...
def apagar_valor_marco(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:marco'))
    return render(request, 'base/marco.html', {'valor': valor})
...
def abril(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/abril.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_abril_dct = Abril.objects.aggregate(Sum('valor'))
    total_mes_abril = total_mes_abril_dct['valor__sum']
    valores_mes = Abril.objects.all()
    return render(request, 'base/abril.html', {'valores_mes': valores_mes, 'total_mes_abril': total_mes_abril})
...
def apagar_valor_abril(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:abril'))
    return render(request, 'base/abril.html', {'valor': valor})
...
def maio(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/maio.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_maio_dct = Maio.objects.aggregate(Sum('valor'))
    total_mes_maio = total_mes_maio_dct['valor__sum']
    valores_mes = Maio.objects.all()
    return render(request, 'base/maio.html', {'valores_mes': valores_mes, 'total_mes_maio': total_mes_maio})
...
def apagar_valor_maio(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:maio'))
    return render(request, 'base/maio.html', {'valor': valor})
...
def junho(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/junho.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_junho_dct = Junho.objects.aggregate(Sum('valor'))
    total_mes_junho = total_mes_junho_dct['valor__sum']
    valores_mes = Junho.objects.all()
    return render(request, 'base/junho.html', {'valores_mes': valores_mes, 'total_mes_junho': total_mes_junho})
...
def apagar_valor_junho(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:junho'))
    return render(request, 'base/junho.html', {'valor': valor})
...
def julho(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/julho.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_julho_dct = Julho.objects.aggregate(Sum('valor'))
    total_mes_julho = total_mes_julho_dct['valor__sum']
    valores_mes = Julho.objects.all()
    return render(request, 'base/julho.html', {'valores_mes': valores_mes, 'total_mes_julho': total_mes_julho})
...
def apagar_valor_julho(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:julho'))
    return render(request, 'base/julho.html', {'valor': valor})
...
def agosto(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/agosto.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_agosto_dct = Agosto.objects.aggregate(Sum('valor'))
    total_mes_agosto = total_mes_agosto_dct['valor__sum']
    valores_mes = Agosto.objects.all()
    return render(request, 'base/agosto.html', {'valores_mes': valores_mes, 'total_mes_agosto': total_mes_agosto})
...
def apagar_valor_agosto(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:agosto'))
    return render(request, 'base/agosto.html', {'valor': valor})
...
def setembro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/setembro.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_setembro_dct = Setembro.objects.aggregate(Sum('valor'))
    total_mes_setembro = total_mes_setembro_dct['valor__sum']
    valores_mes = Setembro.objects.all()
    return render(request, 'base/setembro.html', {'valores_mes': valores_mes, 'total_mes_setembro': total_mes_setembro})
...
def apagar_valor_setembro(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:setembro'))
    return render(request, 'base/setembro.html', {'valor': valor})
...
def outubro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/outubro.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_outubro_dct = Outubro.objects.aggregate(Sum('valor'))
    total_mes_outubro = total_mes_outubro_dct['valor__sum']
    valores_mes = Outubro.objects.all()
    return render(request, 'base/outubro.html', {'valores_mes': valores_mes, 'total_mes_outubro': total_mes_outubro})
...
def apagar_valor_outubro(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:outubro'))
    return render(request, 'base/outubro.html', {'valor': valor})
...
def novembro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/novembro.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_novembro_dct = Novembro.objects.aggregate(Sum('valor'))
    total_mes_novembro = total_mes_novembro_dct['valor__sum']
    valores_mes = Novembro.objects.all()
    return render(request, 'base/novembro.html', {'valores_mes': valores_mes, 'total_mes_novembro': total_mes_novembro})
...
def apagar_valor_novembro(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:novembro'))
    return render(request, 'base/novembro.html', {'valor': valor})
...
def dezembro(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'base/dezembro.html', {'form': form, 'valores_mes': valores_mes}, status=400)

    total_mes_dezembro_dct = Dezembro.objects.aggregate(Sum('valor'))
    total_mes_dezembro = total_mes_dezembro_dct['valor__sum']
    valores_mes = Dezembro.objects.all()
    return render(request, 'base/dezembro.html', {'valores_mes': valores_mes, 'total_mes_dezembro': total_mes_dezembro})
...
def apagar_valor_dezembro(request, pk):
    ...
    if request.method == 'POST':
        valor.delete()
        return HttpResponseRedirect(reverse('base:dezembro'))
    return render(request, 'base/dezembro.html', {'valor': valor})
